/*
 *    Class definition of the SoC Designer component <JPEG>
 *
...
class JPEG : public CASIModule
    , public CASISaveRestore
{
  // Declare your friends here:
  friend class DummyGraphicsMacroModel_AXI_Master_Port<JPEG>;
  friend class DummyGraphicsMacroModel_interrupt_SS<JPEG>;
  friend class DummyGraphicsMacroModel_reset_x_SS<JPEG>;
  friend class DummyGraphicsMacroModel_data_in_SS<JPEG>;
  friend class DummyGraphicsMacroModel_busy_in_SS<JPEG>;

public:
  // Place instance declarations for the Ports here:
  DummyGraphicsMacroModel_AXI_Master_Port<JPEG>* AXIv2_master_TMaster[2];
  DummyGraphicsMacroModel_interrupt_SS<JPEG>* DummyGraphicsMacroModel_interrupt_SSlave[4];
  sc_port<CASISignalIF> *output_SMaster[4];
  DummyGraphicsMacroModel_reset_x_SS<JPEG>* DummyGraphicsMacroModel_reset_x_SSlave;
  DummyGraphicsMacroModel_data_in_SS<JPEG>* DummyGraphicsMacroModel_data_in_SSlave[2];
  DummyGraphicsMacroModel_busy_in_SS<JPEG>* DummyGraphicsMacroModel_busy_in_SSlave[2];
  sc_port<CASISignalIF> *data_out_SMaster[2];
  sc_port<CASISignalIF> *busy_out_SMaster[2];

  // constructor / destructor
  JPEG(CASIModuleIF* c, const string &s);
  virtual ~JPEG();
...
private:
  ...
  fj::uint64 m_b_count[2]; /**< increment when AW is transfered and decrement when B is transfered */
  fj::uint64 m_r_count[2]; /**< save ARLEN and decrement when R is transfered */

  JPEG_wrapperbase *core;
