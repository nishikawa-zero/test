...
#ifndef AXI_MASTER_PORT_FOR_DUMMY_GRAPHICS_MACRO_MODEL_H
#define AXI_MASTER_PORT_FOR_DUMMY_GRAPHICS_MACRO_MODEL_H
...
class DummyGraphicsMacroModel_AXI_Master_Port : public AXI_Master_Port
{

public:
  DummyGraphicsMacroModel_AXI_Master_Port(WrapperClass* _owner, std::string name);
  virtual ~DummyGraphicsMacroModel_AXI_Master_Port() {}
...
private:
  DummyGraphicsMacroModel_AXI_Master_Port();
  DummyGraphicsMacroModel_AXI_Master_Port(const DummyGraphicsMacroModel_AXI_Master_Port<WrapperClass>& rhs);
  DummyGraphicsMacroModel_AXI_Master_Port& operator=(const DummyGraphicsMacroModel_AXI_Master_Port<WrapperClass>& rhs);
