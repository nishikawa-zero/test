/*
 *    Class definition of the SoC Designer component <SD_AXIv2_DummyGraphicsMacroModel>
 *
...
#ifndef SD_AXIv2_DummyGraphicsMacroModel__H
#define SD_AXIv2_DummyGraphicsMacroModel__H
...
class SD_AXIv2_DummyGraphicsMacroModel : public CASIModule
    , public CASISaveRestore
{
  // Declare your friends here:
  friend class DummyGraphicsMacroModel_AXI_Master_Port<SD_AXIv2_DummyGraphicsMacroModel>;
  friend class DummyGraphicsMacroModel_interrupt_SS<SD_AXIv2_DummyGraphicsMacroModel>;
  friend class DummyGraphicsMacroModel_reset_x_SS<SD_AXIv2_DummyGraphicsMacroModel>;

public:
  // Place instance declarations for the Ports here:
  DummyGraphicsMacroModel_AXI_Master_Port<SD_AXIv2_DummyGraphicsMacroModel>* AXIv2_master_TMaster;
  DummyGraphicsMacroModel_interrupt_SS<SD_AXIv2_DummyGraphicsMacroModel>* DummyGraphicsMacroModel_interrupt_SSlave[4];
  sc_port<CASISignalIF> *output_SMaster[4];
  DummyGraphicsMacroModel_reset_x_SS<SD_AXIv2_DummyGraphicsMacroModel>* DummyGraphicsMacroModel_reset_x_SSlave;
  
  // constructor / destructor
  SD_AXIv2_DummyGraphicsMacroModel(CASIModuleIF* c, const string &s);
  virtual ~SD_AXIv2_DummyGraphicsMacroModel();
...
private:
  ...
  DummyGraphicsMacroModel_wrapperbase<DATA_WIDTH_64>  *core_64;
